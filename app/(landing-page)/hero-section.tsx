...
const tabs = [
  {
    ...
    name: "Crea tu DID",
    description: "obten tu DID en la blockchain.",
    more: (
  ...
  },
  {
    ...
    name: "comparte DID",
    description: "Crea,comparte y usa con todo el mundo ",
    more: (
  ...
  },
  {
    ...
    name: "Encuentra trabajos",
    description: "Descubre nuevas oportuniudades laborales,",
    more: (
    ...
    <div className="md:items-center flex flex-col ">
      <div
        className="
          ...
          text-5xl
            ...
            "
      >
        Tu identidad digital , Reinvetada{" "}
      </div>
      ...
      <p
        className="
            ...
            "
      >
        crea una sola vez, Identificate donde sea{" "}
        <span className="text-sky-500 font-bold">Identify</span>
      </p>
